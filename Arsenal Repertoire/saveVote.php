    ...
    <div class="container" style="padding-top:150px;">
    	<div class="row">
          ...
          require('config.php');
					...
					if(isset($_POST["Name"]) && isset($_POST["Email"]) && isset($_POST["serviceNO"]) && isset($_POST["selectedservices"]))
					{
						$name= test_input($_POST["Name"]);
						$email= test_input($_POST["Email"]);
						$service= test_input($_POST["serviceNO"]);
						$selection= test_input($_POST["selectedservices"]);
					}
				}
				else
				{
       ...
       $DB_NAME="db_evoting";
        ...
        or die("Couldn't Connect to Database :");
				...
				$sql= "INSERT INTO db_evoting.tbl_users VALUES(null,'".$name."','".$email."','".$service."','".$selection."');";
